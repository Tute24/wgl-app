...
const mockForgotPasswordService = forgotPasswordService as Mock<typeof forgotPasswordService>;
const req = {
  body: {
...
describe('forgotPasswordController', () => {
  ...
  it('should simulate an error when calling the controller', async () => {
    mockForgotPasswordService.mockRejectedValue(
      new AppError("There's no active user with this e-mail address.", 404),
    );
