...
describe('RegisterForm', () => {
  it('should render the initial state of the component correctly', () => {
    ...
    expect(screen.getByPlaceholderText('Your first name here')).toBeInTheDocument();
    expect(screen.getByPlaceholderText('Your last name here')).toBeInTheDocument();
    expect(screen.getByPlaceholderText('Enter a valid e-mail address')).toBeInTheDocument();
    ...
    expect(screen.getByRole('link', { name: /sign in now!/i })).toHaveAttribute('href', '/');
  });
  ...
  it('should simulate the creation of a new user', async () => {
    ...
    const emailInput = screen.getByPlaceholderText('Enter a valid e-mail address');
