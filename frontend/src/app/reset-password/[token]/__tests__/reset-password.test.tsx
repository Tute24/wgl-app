...
const mockUseSubmitPasswordReset = useSubmitPasswordReset as Mock<typeof useSubmitPasswordReset>;
...
describe('<ResetPassword />', () => {
  ...
  it('renders correctly', () => {
    ...
    expect(screen.getByPlaceholderText(/Your new password here/i)).toBeInTheDocument();
  ...
  it('submits successfully and shows success message', async () => {
    ...
    mockUseGeneralStore.mockReturnValue({
      statusMessage: 'Your password was updated successfully. Go back to the sign in page.',
      isLoading: false,
    });
    ...
    const confirmInput = screen.getByPlaceholderText(/Confirm your password here/i);
    ...
    expect(
      screen.getByText(/Your password was updated successfully\. Go back to the sign in page\./i),
    ).toBeInTheDocument();
  });
