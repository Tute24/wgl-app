    ...
    <Card className=" min-w-[350px] sm:min-w-[450px] pt-6">
      <CardContent>
        <div className="flex flex-col gap-3 justify-start items-start font-inter text-stone-800 font-medium">
          <div>
            Request to access{' '}
            <span className="text-amber-800 font-bold">{`${RequestCardProps.weddingTitle}'s`}</span>{' '}
            list
          </div>
          <div>
            Made by:{' '}
            <span className="text-amber-800 font-bold">{RequestCardProps.requestByName}</span>
          </div>
          <div>
            Made on: <span className="text-amber-800 font-bold">{RequestCardProps.madeOn}</span>
          </div>
        </div>
      </CardContent>
