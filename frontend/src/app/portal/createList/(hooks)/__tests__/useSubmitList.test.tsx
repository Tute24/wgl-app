...
describe('useSubmitList', () => {
  it('calls the hook successfully and populates the zustand stores', async () => {
    ...
    expect(mockSetOwnWeddings).toHaveBeenCalledWith([...mockOwnWeddings, mockWedding]);
    expect(mockSetStatusMessage).toHaveBeenCalledWith('Wedding created successfully!');
  });
