...
describe('NewGiftForm', () => {
  it('should render the initial state correctly', async () => {
    ...
    const weddingTitleInput = screen.getByPlaceholderText(
      `Enter the wedding's name`,
    )
    const weddingDateInput = screen.getByTestId('wedding-date-input')
    const shippingAddressInput = screen.getByPlaceholderText(
      `The gift's delivery address`,
    )
  ...
  it('should create a new wedding', async () => {
    ...
    const productNameInput = await screen.findByPlaceholderText(
      `Enter the product's name`,
    )
    const productLinkInput =
      await screen.findByPlaceholderText(`Link to buy the gift`)
