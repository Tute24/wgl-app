...
describe('useGetGiftedProducts', () => {
  it('calls the hook successfully and populates the stores', async () => {
    ...
    expect(mockSetGiftedProducts).toHaveBeenCalledWith(mockResponseObject.mappingAddGifter);
    expect(mockSetListHeader).toHaveBeenCalledWith(mockResponseObject.listHeader);
