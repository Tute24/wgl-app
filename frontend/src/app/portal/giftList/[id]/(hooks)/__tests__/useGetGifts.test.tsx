...
describe('useGetGifts', () => {
  it('calls the hook successfully and populates the zustand stores', async () => {
    ...
    expect(mockSetIsCreator).toHaveBeenCalledWith(mockResponseObject.checkPreferences.isCreator);
    expect(mockSetIsGuest).toHaveBeenCalledWith(mockResponseObject.checkPreferences.isGuest);
