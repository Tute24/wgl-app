...
describe('GuestGiftCard', () => {
  ...
  it('should render the initial state correctly', () => {
    ...
    expect(screen.queryByText('Type the quantity you want to gift:')).not.toBeInTheDocument();
  ...
  it('should gift a present', async () => {
    ...
    expect(screen.getByText('Type the quantity you want to gift:')).toBeInTheDocument();
