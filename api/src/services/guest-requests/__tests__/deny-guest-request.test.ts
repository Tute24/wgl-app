...
import { DenyGuestRequestService } from '../deny-guest-request';
...
let sut: DenyGuestRequestService;

describe('DenyGuestRequestService', () => {
  beforeEach(() => {
    ...
    sut = new DenyGuestRequestService(authRepository, guestRequestsRepository);
  });
  ...
  it('should accept a guest request successfully', async () => {
    ...
    expect(message).toEqual('Request successfully denied.');
  });
